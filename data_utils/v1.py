...
from data_utils.reporters import DictReporter, StringReporter
from data_utils.scheme import Entities, Token, auto_detect
...
def precision_recall_fscore_support(y_true: List[List[str]],
    ...
    Examples:
        >>> from data_utils.v1 import precision_recall_fscore_support
        >>> from data_utils.scheme import IOB2
